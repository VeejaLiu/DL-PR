    ...
    function init() {
        ...
        uploader.on("error", function (handler, file) {
            if (handler == "Q_TYPE_DENIED") {
                ...
                layer.msg("上传出错！请检查后重新上传！错误代码" + handler);
                return false;
            }
        });
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            resp[resp.length] = response.data;

            //parent.window.addImgParams=response.data;
            //parent.window.addImg_Dr(response.data);


        });
        uploader.on('uploadFinished', function (file, response) {

            parent.window.addImgParams = resp;
